...
const Cohort = ({
    ...
    return (
        <>
            {isPaper ? (
                <McqPaperPage packageId={packageId} mcqId={mcqId} PaperType="Cohort" />
            ) : (
                    ...
                    {mcqList.length > 0 ? (
                        mcqList.map((data: any) => (
                            ...
                            >
                                ...
                                <button className="w-full text-center px-4 py-2 bg-blue-500 text-white rounded-md font-semibold hover:bg-blue-600 transition duration-200 mt-2"
